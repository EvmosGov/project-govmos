...
/// @custom:security-contact contact@evmos.community
contract EvmosDAO is Initializable, GovernorUpgradeable, GovernorSettingsUpgradeable, GovernorCompatibilityBravoUpgradeable, GovernorVotesUpgradeable, GovernorVotesQuorumFractionUpgradeable, GovernorTimelockControlUpgradeable {
    ...
    function initialize(IVotesUpgradeable _token, TimelockControllerUpgradeable _timelock)
        initializer public
    {
        __Governor_init("EvmosDAO");
        __GovernorSettings_init(21600 /* 12 hours */, 216000 /* 5 days */, 1e18);
